...
namespace Muse
{
	...
	{
	public:
		CheckerBoardMaterial(const glm::vec3& a_Color1 = glm::vec3(0.f, 0.f, 1.f), const glm::vec3& a_Color2 = glm::vec3(1.f, 0.f, 0.f), float a_GridSize = 2, float a_SpeculairStrength = 0.5f);
